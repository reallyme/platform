...
// These crates were published from clean commit
...
if (
  ...
  console.error(
    `usage: node scripts/release/publish_crates_in_order.mjs ` +
...
function verifyPublicationWorktree() {
  ...
  for (const generatedDirectory of ["apps/example/contract/src/generated"]) {
