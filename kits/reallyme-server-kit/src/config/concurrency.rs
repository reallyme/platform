...
mod tests {
    ...
    fn accepts_boundary_concurrency_limits() {
        assert!(
            RuntimeConcurrencyLimit::new(1, ConcurrencyLimitConfigField::HttpInFlightRequests)
                .is_ok()
        );
        assert_eq!(
            RuntimeConcurrencyLimit::new(
    ...
    fn concurrency_limits_are_exact_fail_closed_admission_control() {
        let limit =
            RuntimeConcurrencyLimit::new(16, ConcurrencyLimitConfigField::HttpInFlightRequests)
