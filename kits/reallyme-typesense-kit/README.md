...
implicitly by this kit. `reallyme-search-index` retains a compatibility re-export
for existing code, but new infrastructure imports should use this kit directly.
